...
class HomeAutomationServer(socketio.Namespace):
	...
	def get_room_events(sid, data):
		...
		room = HomeAutomationServer.homeAutomationSystem.get_home_room(data)
		for element in room.events:
			events.append(element.serialize())
	...
	def add_guest(sid, data):
		HomeAutomationServer.homeAutomationSystem.add_home_guest(data["firstName"], data["lastName"])
		print(data)


	@socketIoServer.event(namespace='/HomeAutomationServer')
	def del_module(sid, data):
		HomeAutomationServer.homeAutomationSystem.del_home_automation_module()
		print(data)

	@socketIoServer.event(namespace='/HomeAutomationServer')
	def del_room(sid, data):
		HomeAutomationServer.homeAutomationSystem.del_home_room(int(data['roomId']))
		print(data)
